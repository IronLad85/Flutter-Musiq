...
import 'package:flutter_musiq/src/common/empty_screen.dart';
import 'package:flutter_musiq/src/models/album.dart';
import 'package:flutter_musiq/src/ui/albums/album_tile.dart';
import 'package:flutter_musiq/src/ui/albums/specific_album_screen.dart';
      ...
      body: StreamBuilder<List<Album>>(
        ...
        builder: (BuildContext context, AsyncSnapshot<List<Album>> snapshot) {
          ...
          return GridView.builder(
            ...
            padding: EdgeInsets.only(left: 16.0, right: 16.0, top: 16.0, bottom: 150),
            ...
            itemBuilder: (BuildContext context, int index) {
              return GestureDetector(
                ...
                child: Hero(
                  tag: 'albumImage${_albums[index].id}',
                  child: AlbumTile(
                    album: _albums[index],
                  ),
                ),

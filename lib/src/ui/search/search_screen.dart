...
import 'package:flutter_musiq/src/ui/search/search_screen_bloc.dart';
              ...
              itemBuilder: (BuildContext context, int index) {
                return StreamBuilder<MapEntry<PlayerState, Song>>(
                  ...
                  builder: (BuildContext context, AsyncSnapshot<MapEntry<PlayerState, Song>> snapshot) {
                    ...
                    final bool _isSelectedSong = _currentSong == _filteredSongs[index];
                    return GestureDetector(
                      onTap: () {
                        _globalBloc.musicPlayerBloc.updatePlaylist(_filteredSongs);
                        switch (_state) {
                          ...
                          case PlayerState.paused:
                            if (_isSelectedSong) {
                              _globalBloc.musicPlayerBloc.playMusic(_filteredSongs[index]);
                            } else {
                              _globalBloc.musicPlayerBloc.stopMusic();
                              _globalBloc.musicPlayerBloc.playMusic(
                                _filteredSongs[index],

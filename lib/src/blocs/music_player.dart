...
class MusicPlayerBloc {
  ...
  BehaviorSubject<MapEntry<List<Song>, List<Song>>> _playlist$; //key is normal, value is shuffle
  ...
  BehaviorSubject<MapEntry<PlayerState, Song>> get playerState$ => _playerState$;
  ...
  BehaviorSubject<bool> get isAudioSeeking$ => _isAudioSeeking$;
  ...
  void playNextSong() {
    ...
    final List<Song> _playlist = _isShuffle ? _playlist$.value.value : _playlist$.value.key;
